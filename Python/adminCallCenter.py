...
print("BIENVENIDO A AEROLINEA NUEVA: ")
       ...
       print("\nNo has seleccionado una de las opciones validas, intenta nuevamente")
        ...
        if menuu==5:  # *archivo en txt    *****************************************************************
            try: 
                ...
                m=("Admin call center. JONNATHAN MONROY "+notas1+notas2+notas3)
                ...
                with open("C:/Users/USUARIO/Desktop/UNAB/arjonnathanm.txt","a") as abrirarchivo:
                    print(abrirarchivo.writelines(["Documento generado con python"]))
                    print(abrirarchivo.writelines(["Listas de Administracion de call center."]))
